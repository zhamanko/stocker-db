...
<template>
    <div class="fixed top-0 left-0 bg-black/60 w-full h-full">
        <div
            class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white p-6 rounded-lg w-1/2">
            <p>{{ massage }}</p>
            ...
            <div class="text-end">
                ...
                <div v-if="type === 'confirm'" class="space-x-2">
                    ...
                    <button class="bg-green-500 text-white px-4 py-2 rounded mt-4 hover:bg-green-600 transition" @click="handleClick(true)">Так</button>
                </div>
            </div>
        </div>
    </div>
